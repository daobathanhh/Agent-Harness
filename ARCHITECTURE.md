...
| Stream subscriber disconnect | `unsub()` sets `closed` flag before closing channel | `broadcast` checks flag under RLock, skips closed subscribers. Slow consumers get events dropped |
